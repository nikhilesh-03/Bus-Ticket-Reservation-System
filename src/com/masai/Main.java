...
public class Main {
	...
	public static String adminAddBus(Scanner sc, Map<Integer, Bus> buses, BusService busService) {
		...
		int busId = IDGeneration.generateId();

		Bus bus = new Bus(busId, name, totalSeat, busType, price, source, destination);

		String temp = "";
		try {
			temp = busService.addBus(bus, buses);
	...
	public static String adminUpdateBus(Scanner sc, Map<Integer, Bus> buses, BusService busService)
		...
		int id = sc.nextInt();
		System.out.println("Enter the updated details for the bus");
	...
	public static void passengerSignup(Scanner sc, Map<String, Passenger> passengers) throws DuplicateDataException {
		...
		Passenger pas = new Passenger(name, pass, mobileNo, email, balance);

		PassengerService pasService = new PassengerServiceImpl();
		pasService.signUp(pas, passengers);
		System.out.println("Passenger has sign up successfully !");
	...
	public static void passengersViewPassengerTransactions(String email, List<Transaction> transactions,
			TransactionService transactionService) throws TransactionException {
		List<Transaction> myTransactions = transactionService.viewPassengerTransactions(email, transactions);
